...
public class VisitadoresNew {

    public VisitadoresNew(int id_codigo, int dni, String apellido, String nombre, String email, String photo, int citas_hechas, int citas_totales) {
